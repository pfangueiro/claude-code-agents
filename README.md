...
[![Version](https://img.shields.io/badge/version-2.9.4-blue.svg)](https://github.com/pfangueiro/claude-code-agents/releases)
...
| **Validate** | `./validate.sh` | Verify all 170 checks pass |
...
```bash
./validate.sh
# All validations passed! (150/170 checks)
```
